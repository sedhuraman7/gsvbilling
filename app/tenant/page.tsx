...
export default function TenantDashboard() {
    ...
    return (
        <div className="min-h-screen bg-transparent text-white font-sans pb-20">
            {/* HEADER */}
            <header className="glass-panel text-white p-4 shadow-lg shadow-black/20 flex justify-between items-center sticky top-0 z-10">
                <div className="flex items-center gap-2">
                    <div className="bg-orange-100 p-2 rounded-full"><Zap className="h-5 w-5 text-orange-600" /></div>
                    <div>
                        <h1 className="font-bold text-white text-sm">Tenant Portal</h1>
                        <p className="text-xs text-blue-300">{houseId} • {tenantName}</p>
                    </div>
                </div>
                <button onClick={handleLogout} className="text-blue-300 hover:text-red-500"><LogOut className="h-5 w-5" /></button>
            </header>
            ...
            <main className="p-4 space-y-4">
                ...
                <Card className="bg-gradient-to-br from-blue-600 to-blue-800 text-white border-none shadow-lg">
                    <CardContent className="p-6">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <div className="text-xs glass-panel text-white/20 px-2 py-1 rounded">Today</div>
                        </div>
                ...
                {/* INFO */}
                <div className="glass-panel text-white p-4 rounded-xl border shadow-lg shadow-black/20">
                    <h3 className="font-bold text-white mb-2 flex items-center gap-2"><Clock className="h-4 w-4 text-blue-300" /> Billing Cycle</h3>
                    <p className="text-sm text-blue-200 mb-2">The next bill will be generated by the owner at the end of the month.</p>
